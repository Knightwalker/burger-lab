...
const PostCreatePage = () => {
  ...
  */
  const fTopicCreate = async (e) => {
    ...
    try {
      const result = await fetch(`http://localhost:5000/api/v1/topics/create/${forum_id}`, {
        method: "POST",
        headers: {
    ...
    <MainLayout>
      <div className="PostCreatePage">
        <div className="container">
          <div className="main__head">New Topic</div>
            ...
            <div className="container-fluid">
              ...
              <div className="row">
                ...
                <div className="col">
                  ...
                  <p>BBCode is ON</p>
                  <p>Smiles are OFF</p>
                  <ValorantButton onClick={fTopicCreate}>Send</ValorantButton>
                </div>
              </div>
            </div>
          </form>
